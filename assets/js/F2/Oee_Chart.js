...
async function updateOEEChart(period) {
    try {
        const response = await fetch(`api/F2/get_oee_data.php?period=${period}`);
    ...
    <tr>
        <td style="padding: 8px;">
            ...
            <div style="margin: 2px 0; font-size: 12px;">
                ...
                <span style="color: #666;">Line 1:</span>
                <span style="float: right; font-weight: 600; color: ${data.line1OEE[dataIndex] >= 89 ? '#36A2EB' : '#FF4444'}">${data.line1OEE[dataIndex].toFixed(1)}%</span>
            </div>
            <div style="margin: 2px 0; font-size: 12px;">
                <span style="display: inline-block; width: 8px; height: 8px; background: #FF9800; border-radius: 50%; margin-right: 8px;"></span>
                <span style="color: #666;">Line 2:</span>
                <span style="float: right; font-weight: 600; color: ${data.line2OEE[dataIndex] >= 89 ? '#36A2EB' : '#FF4444'}">${data.line2OEE[dataIndex].toFixed(1)}%</span>
            </div>
            <div style="margin: 2px 0; font-size: 12px;">
                <span style="display: inline-block; width: 8px; height: 8px; background: #4CAF50; border-radius: 50%; margin-right: 8px;"></span>
                <span style="color: #666;">Line 3:</span>
                <span style="float: right; font-weight: 600; color: ${data.line3OEE[dataIndex] >= 89 ? '#36A2EB' : '#FF4444'}">${data.line3OEE[dataIndex].toFixed(1)}%</span>
            </div>
            <div style="margin: 2px 0; font-size: 12px;">
                <span style="display: inline-block; width: 8px; height: 8px; background: #FF9800; border-radius: 50%; margin-right: 8px;"></span>
                <span style="color: #666;">Line 4:</span>
                <span style="float: right; font-weight: 600; color: ${data.line4OEE[dataIndex] >= 89 ? '#36A2EB' : '#FF4444'}">${data.line4OEE[dataIndex].toFixed(1)}%</span>
            </div>           
            <div style="margin: 2px 0; font-size: 12px;">
